...
#
#Instrucciones
#1.	A continuación puedes encontrar un breve texto que describe una historia de ciencia ficción:
## Primera parte:
...
#
#2.	Tu tarea es escribir un programa en Python que transforme este texto en un formato que combine comentarios y strings imprimibles.
#3.	La primera parte del texto debe ser transformada en un comentario de varias líneas que dé una introducción general a la historia.
#4.	Respecto a la segunda parte, se deben imprimir por pantalla las frases que expresen los personajes y representar en el código como comentario de una sola línea el texto adicional.
#
#Resultado esperado
#Capitan garcía: 'Este lugar es más impresionante de lo que imaginé.'
#
